...
export default function Profile() {
    ...
    return (
        <ScrollView style={{flex: 1,maxHeight : height - 119 }}>
            <View style={{width}}>  
                ...
                <View style={styles.profile_actions}>
                    ...
                    <Pressable style={{...styles.action_button ,...styles.more_button}} >
                        <Text style={{...styles.btn_text, color: "#ECECEC"}}>...</Text>
                    </Pressable>
                </View>
                ...
                <View style={styles.tabs}>
                    <View style={{...styles.tab_indicator, [indicator.at]: indicator.position}}>
                    </View>
